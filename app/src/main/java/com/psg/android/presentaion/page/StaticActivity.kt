...
class StaticActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var right_to_left_anim =
            AnimationUtils.loadAnimation(this@StaticActivity, R.anim.right_to_left).apply {
                duration = 700
                interpolator = AccelerateDecelerateInterpolator()
            }

        var left_to_right_anim =
            AnimationUtils.loadAnimation(this@StaticActivity, R.anim.left_to_right).apply {
                duration = 700
                interpolator = AccelerateDecelerateInterpolator()
            }
                ...
                when (event.action) {
                    ...
                    MotionEvent.ACTION_UP -> {
                        ...
                        if (deltaX > SWIPE_THRESHOLD) {
                            ...
                            left_to_right_anim.setAnimationListener(object :
                                Animation.AnimationListener {
